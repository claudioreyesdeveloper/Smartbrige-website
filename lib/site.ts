...
export const VIDEO_LIBRARY = {
  ...
  chordDatabase: youtubeVideo("91dTEKuc8LE", "SmartBridge and the database of chord progressions"),
  jamSessionChords: youtubeVideo("yU3bXdf_Jk8", "Using Jam Session to create your own chord progressions"),
  chordPro: youtubeVideo("aKD-5q6FQWQ", "SmartBridge and ChordPro"),
  guitarLibraries: youtubeVideo("hnV7lnrGVPY", "SmartBridge and the guitar libraries"),
  superGroove: youtubeVideo("iH_3ZFzr1ik", "SuperGroove redesigned with SmartBridge"),
  ...
  synthV: youtubeVideo("azqq3VBnTQw", "SmartBridge and Synthesizer V integration"),
  rockSong: youtubeVideo("4pg6iBNCIng", "Creating a rock song with SmartBridge and Synthesizer V"),
  vocalAndSolo: youtubeVideo("spvlH81uyi4", "New Vocal Generator & Solo Phrases Update"),
  brassStringsSynthV: youtubeVideo(
    "LN3JklYfcrY",
    "Brass, Strings & Synthesizer V Integration",
  ),
  soloPhrases: youtubeVideo("UNBGDCi8-Cc", "New Solo Phrase Feature for Music Composition"),
  soloPhrases80s: youtubeVideo("1cJNGaID7h8", "Solo Phrases — 80s Power Rock & Pop Rock"),
  popHorns: youtubeVideo("2JzTwx45PR4", "Pop Horns Showcase"),
  lyricsRock: youtubeVideo("-GMGe_C6Zbk", "Lyrics showcase with a typical rock song"),
  ...
  finishedSong: youtubeVideo("1zKXAAAZrmc", "Finished song using SmartBridge and Synthesizer V"),
  firstVersion: youtubeVideo("RkSi3RGmAYQ", "SmartBridge 1.0 — first version packed with new features"),
  ...
  lennySong: youtubeVideo("QiQ5DqTEMv4", "Creating a Lenny Kravitz–type song"),
  ballad: youtubeVideo("tuTRgiZ3j0I", "Creating a Ballad in 10 min"),
  sysex: youtubeVideo("3NDS378JnJ4", "SmartBridge instead of Sysex Messages"),
  tyrosMixer: youtubeVideo("arHZdbS_Qig", "SmartBridge using the Tyros Mixer"),
}
...
export const PRODUCT_VIDEO_GUIDES: ProductVideoGuide[] = [
  ...
  {
    title: "SmartBridge and the database of chord progressions",
  ...
  {
    title: "Using Jam Session to create your own chord progressions",
  ...
  {
    title: "SuperGroove redesigned with SmartBridge",
  ...
  {
    title: "Brass, Strings & Synthesizer V Integration",
  ...
  {
    title: "Solo Phrases — 80s Power Rock & Pop Rock",
  ...
  {
    title: "Lyrics showcase with a typical rock song",
  ...
  {
    title: "Finished song using SmartBridge and Synthesizer V",
  ...
  {
    title: "SmartBridge 1.0 — first version packed with new features",
  ...
  {
    title: "Creating a Lenny Kravitz–type song",
  ...
  {
    title: "SmartBridge using the Tyros Mixer",
